    ...
    <div class="grid grid-cols-2 gap-6 card-body lg:grid-cols-1">
        ...
        <div class="p-8">
            ...
            <div class="flex items-center mt-20 mb-2">
                ...
                <p class="text-black"><span class="text-green-400 num-2"></span><span class="text-green-400">% more
            ...
            <div class="flex items-center">
                ...
                <p class="text-black"><span class="text-red-400 num-2"></span><span class="text-red-400">% revenue per
    ...
    <div class="col-span-2 card xl:col-span-1">
        ...
        <table class="w-full text-left table-auto">
            ...
            <tbody class="text-gray-600">
                ...
                <tr>
                    <td class="px-4 py-2 text-center text-green-500 border border-l-0"><i class="fad fa-circle"></i>
                    </td>
                ...
                <tr>
                    <td class="px-4 py-2 text-center text-yellow-500 border border-l-0"><i class="fad fa-circle"></i>
                    </td>
                ...
                <tr>
                    <td class="px-4 py-2 text-center text-red-500 border border-l-0"><i class="fad fa-circle"></i>
                    </td>
                ...
                <tr>
                    <td class="px-4 py-2 text-center text-green-500 border border-b-0 border-l-0"><i
                    ...
                    <td class="px-4 py-2 border border-b-0 border-l-0 border-r-0"><span class="num-2"></span> minutes
                        ago</td>
                </tr>
